		...
		<div class="login" style="display: block;">
			...
			<div class="login-center clearfix">
				...
				<div class="login-center-input">
					...
					<img id="cpacha-img" title="点击切换验证码" style="cursor:pointer;" src="get_cpacha?vcodeLen=4&width=150&height=40&type=loginCpacha" width="110px" height="30px" onclick="changeCpacha()">
				</div>
			</div>
...
<script type="text/javascript">
	...
	function changeCpacha(){
		$("#cpacha-img").attr("src",'get_cpacha?vcodeLen=4&width=150&height=40&type=loginCpacha&time=' + new Date().getTime());
	}
		document.querySelector(".login-button").onclick = function(){
				...
				$.ajax({
					url:'login',
					data:{name:name,password:password,cpacha:cpacha},
					type:'post',
					dataType:'json',
					success:function(data){
						
						if(data.type == 'success'){
							window.parent.location = 'list.jsp';
						}else{
